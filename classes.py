...
class Ball(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.Surface((2 * self.radius, 2 * self.radius))  # объект - поверхность - квадрат со стороной 2 радиуса
        self.image.set_alpha(255)  # делает поверхность непрозрачной
